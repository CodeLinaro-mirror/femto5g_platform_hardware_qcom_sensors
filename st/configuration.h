...
#define CONFIG_ST_HAL_ANDROID_VERSION 6


#define CONFIG_ST_HAL_ACCEL_ENABLED 1
#define CONFIG_ST_HAL_GYRO_ENABLED 1
#define CONFIG_ST_HAL_CONFIG_INOTIFY_ENABLED 1
