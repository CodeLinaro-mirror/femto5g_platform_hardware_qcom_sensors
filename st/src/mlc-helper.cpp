/*
This file is copied from https://github.com/STMicroelectronics/STMems-Platform1-IIO-SensorHAL/blob/linux-3.18.y-gh/st/src/mlc-helper.cpp which is under the following license:
...
static char st_getDataAtFixedRate(st_sensorData *state,
				  float inputData[3],
				  float *outData, int64_t t)
{
	char valid = 0;
	int n;
	int64_t tCurrent, dt;
